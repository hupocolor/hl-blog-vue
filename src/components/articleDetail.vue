...
<template>
        <div class="detailBox tcommonBox" >
            ...
            <header>
                <h1>
                    <a :href="'#/DetailShare?aid='+detailObj.blogId" target="_blank">
                        {{detailObj.blogTitle}}
                    </a>
                </h1>
                <h2>
                    <i class="fa fa-fw fa-user"></i>发表于 <span >{{detailObj.createTime}}</span> •
                    <i class="fa fa-fw fa-eye"></i>{{detailObj.blogViews}} 次围观 •
                </h2>
                <div class="ui label">
                    <a :href="'#/Share?classId='+detailObj.blogCategoryId">{{detailObj.categoryName}}</a>
                </div>
            </header>
