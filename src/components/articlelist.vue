...
<template>
    <el-row class="sharelistBox">
        ...
        <el-col :span="24" class="s-item tcommonBox" v-for="(item,index) in articleList" :key="'article'+index">
            ...
            <header>
                <h1>
                    <a :href="'#/DetailArticle?aid='+item.blogId" target="_blank">
                        {{item.blogTitle}}
                    </a>
                </h1>
                <h2>
                    ...
                    <i class="fa fa-fw fa-eye"></i>{{item.blogViews}} 次围观 •
            ...
            <div class="article-content">
                ...
                <p  style="max-height:300px;overflow:hidden;text-align:center;">
                    <img :src="item.blogCoverImage" alt="" class="maxW">
                </p>
            </div>
            <div class="viewdetail">
                <a class="tcolors-bg" :href="'#/DetailArticle?aid='+item.blogId" target="_blank">
                    阅读全文>>
                </a>
            </div>
